...
for( var salesDataDepartment in salesDataMap){
  ...
  // 
  function leastProfitableDepartment(salesData){
...
for(var i=0; i<salesData.length;i++){
  ...
  var currentMinSales=60000
var currentlDepartment="";
for( var salesDataDepartment in salesDataMap){
	
	var currentSalesDataDepartmentSales= salesDataMap[salesDataDepartment];
	if(currentSalesDataDepartmentSales< currentMinSales){
		currentMinSales=currentSalesDataDepartmentSales
		currentlDepartment= salesDataDepartment;
	}
}
 
  return currentlDepartment
  }